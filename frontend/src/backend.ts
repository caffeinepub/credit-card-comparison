...
import type { APRRange as _APRRange, CreditCard as _CreditCard, RewardsRate as _RewardsRate, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllCards(): Promise<Array<CreditCard>> {
        if (this.processError) {
            try {
    ...
    async getCardsByCategory(arg0: string): Promise<Array<CreditCard>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCardsByCategory(arg0);
                return from_candid_vec_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSortedCards(arg0: string): Promise<Array<CreditCard>> {
        if (this.processError) {
            try {
...
function from_candid_CreditCard_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CreditCard): CreditCard {
    return from_candid_record_n10(_uploadFile, _downloadFile, value);
}
function from_candid_RewardsRate_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RewardsRate): RewardsRate {
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        creditScoreRequired: value.creditScoreRequired,
        annualFee: value.annualFee,
        signupBonus: value.signupBonus,
        name: value.name,
        description: value.description,
        issuer: value.issuer,
        rewardsRate: from_candid_RewardsRate_n11(_uploadFile, _downloadFile, value.rewardsRate)
    };
}
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        miles: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.miles)),
        cashBack: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.cashBack)),
        points: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.points))
    };
}
...
function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CreditCard>): Array<CreditCard> {
    return value.map((x)=>from_candid_CreditCard_n9(_uploadFile, _downloadFile, x));
}
